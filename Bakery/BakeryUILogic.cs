...
namespace BakeryStoreFront
{
  public class Program
  {
    ...
    {
      Console.WriteLine("Welcome to Pierre's Bakery! We sell bread and pastries and have a special today so I can get home to watch my show double quick: For every two loaves of bread, you get one free, and for every three pastries, you get one pastry free! Whether or not you want it!");
      while(true)
      {
